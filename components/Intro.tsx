    ...
    >
      ...
      >
        <Link
          ...
          href="/Muhammad Hamza.pdf" // Link directly to the public folder file
          locale={false}
        >
          {t("download_cv")}
          <HiDownload />
        ...
        <a
          ...
          href="www.linkedin.com/in/muhammad-hamza-507761274"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <div className="flex flex-col items-center gap-3 mt-4 sm:flex-row sm:justify-center">
          <p className="text-lg text-gray-700 dark:text-white">
            <span className="font-bold">Contact:</span> +923401304435
          </p>
          <p className="text-lg text-gray-700 dark:text-white">
            <span className="font-bold">Email:</span> hamzapersnol321@gmail.com
          </p>
        </div>
      </motion.div>
    </section>
